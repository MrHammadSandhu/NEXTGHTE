...
const SecondaryBtn = ({ href, className = "", text, datatranslatekey }) => {
  return (
    <Link
      href={href}
      className={`group relative text-white flex items-center justify-between py-3 sm:py-4 lg:py-4 rounded-xl  px-4 sm:px-6 lg:px-8 text-base sm:text-lg lg:text-xl font-semibold bg-secondary overflow-hidden transition-all duration-300 ${className}`}
      data-key="btn"
    >
      {/* Sliding Background */}
